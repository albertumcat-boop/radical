...
const CACHE_NAME   = 'patronai-v100';
const CACHE_STATIC = 'patronai-static-v100';
...
const STATIC_ASSETS = [
  ...
  '/js/clients.js',
  '/js/measurement-profiles.js',
  '/js/saved-patterns.js',
  '/js/measure-table.js',
  '/js/toolbar-config.js',
  '/js/bloques.js',
  '/js/bloques-ui.js',
  '/js/pizarra.js',
  '/js/pizarra-ui.js',
  '/js/mis-sistemas.js',
  '/js/mis-sistemas-ui.js',
  '/js/materiales.js',
  '/js/materiales-ui.js',
  '/js/notas-usuario.js',
  '/js/wizard.js',
  '/js/pattern-grading.js',
  '/js/piece-bases.js',
  '/js/entrevista-sistema.js',
  '/js/help-panel.js',
  '/js/paywall.js',
  '/tienda.html',
  '/js/tienda.js',
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando PatrónAI v100...');
  event.waitUntil(
